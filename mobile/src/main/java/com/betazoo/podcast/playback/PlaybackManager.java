...
package com.betazoo.podcast.playback;
...
public class PlaybackManager implements Playback.Callback {
    ...
    private static final String CUSTOM_ACTION_THUMBS_UP = "com.betazoo.podcast.THUMBS_UP";
    private static final String CUSTOM_ACTION_URL_UPDATE = "com.betazoo.podcast.UPDATE";
    ...
    private class MediaSessionCallback extends MediaSessionCompat.Callback {
        ...
        public void onCustomAction(@NonNull String action, Bundle extras) {
            if (CUSTOM_ACTION_THUMBS_UP.equals(action)) {
                ...
                updatePlaybackState(null);
            }else if(CUSTOM_ACTION_URL_UPDATE.equals(action)) {
                String url = extras.getString("url");
                LogHelper.i(TAG, "onCustomAction: new playlist url = ", url);
                //mQueueManager.setNewQueue(url);

                // update playback state because now song list changes
                updatePlaybackState(null);
            }
            else {
