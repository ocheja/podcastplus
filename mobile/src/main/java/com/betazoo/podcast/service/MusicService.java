...
package com.betazoo.podcast.service;
...
import com.betazoo.podcast.model.MusicProvider;
import com.betazoo.podcast.model.episode.Episode;
import com.betazoo.podcast.playback.CastPlayback;
import com.betazoo.podcast.playback.LocalPlayback;
import com.betazoo.podcast.playback.Playback;
import com.betazoo.podcast.playback.PlaybackManager;
import com.betazoo.podcast.playback.QueueManager;
import com.betazoo.podcast.ui.NowPlayingActivity;
import com.betazoo.podcast.utils.CarHelper;
import com.betazoo.podcast.utils.LogHelper;
import com.betazoo.podcast.utils.TvHelper;
import com.betazoo.podcast.utils.WearHelper;
...
import static com.betazoo.podcast.utils.MediaIDHelper.MEDIA_ID_EMPTY_ROOT;
import static com.betazoo.podcast.utils.MediaIDHelper.MEDIA_ID_ROOT;
...
public class MusicService extends MediaBrowserServiceCompat implements
    ...
    public static final String EXTRA_CONNECTED_CAST = "com.betazoo.podcast.CAST_NAME";
    // The action of the incoming Intent indicating that it contains a command
    // to be executed (see {@link #onStartCommand})
    public static final String ACTION_CMD = "com.betazoo.podcast.ACTION_CMD";
    ...
    public void onCreate() {
        ...
        mMusicProvider.retrieveMediaAsync(null /* Callback */, getApplicationContext());
    ...
    public void onLoadChildren(@NonNull final String parentMediaId,
        ...
        if (MEDIA_ID_EMPTY_ROOT.equals(parentMediaId)) {
        ...
        else if (parentMediaId.startsWith("FeedId:")) {
            Log.e("PlayEpisode", "got here");
            int feedId = Integer.parseInt(parentMediaId.split(":")[1]);
            List <MediaItem> episodeItem = new ArrayList<>();
            Episode episode =
                    new Episode(1,
                    "Everyday my hope increases",
                    "World is crazy but we are more powerful than we look. The power built into human is beyond the earth.",
                    "http://104.131.165.69:8082/audios/1503306110XZn8jI7ySCNW6je9HHLbPvELPltoKZUfgYQIEsmy.mpga",
                    "2017-08-23 11:20:33",
                    0,
                    0,
                    0,
            ...
            episodeItem.add(createBrowsableMediaItemFromEpisode(episode));
            result.sendResult(episodeItem);
