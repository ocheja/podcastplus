...
public class ChannelBrowserFragment extends Fragment {
    ...
    private  void loadItem()
    {
        ...
        final Call<ChannelResult> channelResultCall = mPodcastAPIService.getChannel(token, Integer.parseInt(getMediaId()));
        channelResultCall .enqueue(new Callback<ChannelResult>() {
            @Override
            public void onResponse(Call<ChannelResult> call, Response<ChannelResult> response) {
                try
                {
                    ...
                    if(response.body().getData().getData() == null || response.body().getData().getData().isEmpty())
                        makeSnackBar("Channels not available! Check Back");
    ...
    public void setMediaId(String mediaId) {
        ...
        args.putString(ChannelBrowserFragment.ARG_MEDIA_ID, mediaId);
        setArguments(args);
    }
