...
import com.betazoo.podcast.adapter.EpisodeAdapter;
...
import com.betazoo.podcast.utils.FastBlurTransformation;
 ...
 */
public class EpisodeBrowserFragment extends Fragment {
    private static final String TAG = LogHelper.makeLogTag(EpisodeBrowserFragment.class);

    private static final String ARG_MEDIA_ID = "media_id";

    public static final String ARG_POD ="com.betazoo.podcast.bundle";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.episode_list, container, false);
        ...
        ImageView featuredImage = (ImageView) rootView.findViewById(R.id.img_episode);
        featuredImage.setColorFilter(new LightingColorFilter(0xff828282, 0x000000));
    ...
    private  void loadItem()
    {
        ...
        final Call<EpisodeResult> episodeResultCall = mPodcastAPIService.getEpisodebyChannel(token, Integer.parseInt(getMediaId()));
            ...
            public void onResponse(Call<EpisodeResult> call, Response<EpisodeResult> response) {
                try
                {
                    ...
                    if(response.body().getData().getData() == null || response.body().getData().getData().isEmpty())
                        makeSnackBar("Episodes not available! Check Back");
                    itemList.addAll(response.body().getData().getData());
                    EpisodeAdapter recylerAdapter = new EpisodeAdapter (EpisodeBrowserFragment.this.getActivity(), itemList);
                ...
                catch(NullPointerException e)
                {
                    ...
                    Toast.makeText(EpisodeBrowserFragment.this.getActivity(), "Login Failed! Please Try Again", Toast.LENGTH_LONG).show();
                }
            }
    ...
    public void setMediaId(String mediaId) {
        ...
        args.putString(EpisodeBrowserFragment.ARG_MEDIA_ID, mediaId);
        setArguments(args);
    }
