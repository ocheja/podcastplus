...
import com.betazoo.podcast.service.AlbumArtCache;
...
public class MediaItemViewHolder {
    ...
    ImageView mFeaturedImageView;
    private static String  mCurrentArtUrl;
    ...
    static View setupListView(Activity activity, View convertView, ViewGroup parent,
        ...
        if (convertView == null) {
            ...
            holder.mFeaturedImageView = (ImageView) convertView.findViewById(R.id.imgFeatured);
        ...
        Glide.with(convertView.getContext())
                ...
                .dontAnimate()
                .into(holder.mFeaturedImageView);
